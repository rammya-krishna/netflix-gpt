...
const Header = () => {
  ...
  return (
    <>
      ...
      {/* <div className="px-6 py-2 md:py-2 flex flex-row justify-center md:justify-start"> */}
        
        <img
          className="w-50 bg-gradient-to-l md:bg-gradient-to-r from-black h-28 md:h-32"
